...
1. Trình duyệt **request** đén server và trả về file `index.html` cơ bản (hầu như không chứa html gì nhiều)
...
Trong Next.js, mặc dịnh tất cả các component đều được render ra HTML sẵn khi có thể lúc Nextjs build (Static Rendering). Kể cả Server component và client component.
